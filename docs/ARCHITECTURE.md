...
| `protocol/mod.rs`         | **Internal** daemon IPC v1.0 message types + JSON codec (NOT A2A) |
| `ipc/mod.rs`              | Unix-socket server (tokio async)                  |
| `security/capability.rs`  | Capability-based policy (code-complete; IPC wiring is a P1 follow-up) |
